...
export default class KorpaComponent implements OnInit {
    ...
    idKorpe: number;
    totalPrice: number = 0;
    isDone : boolean = false;//da zna da li da prikaze korpu ili narudzbenicu

//zastita, ako nema tokena vraca na pocetnu stranu, da ne moze rucno da se pristupi korpi
